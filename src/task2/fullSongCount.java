...
public class fullSongCount {
  ...
  public static void main(String[] args) throws Exception {
	...
	job.setJarByClass(fullSongCount.class); 
    ...
    job.setMapperClass(fullSongCountMapper.class);
    job.setReducerClass(fullSongCountReducer.class);
